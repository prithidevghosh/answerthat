...
class ReviewRunner(Protocol):
    ...
    def stream(self, doc_id: str) -> Any:
        """Yields `(event_name, payload)`. Raises for a document whose review was never
        started — an empty stream is indistinguishable from a review that found nothing."""
        ...
